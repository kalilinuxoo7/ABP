...
In order to support loading of multiple wallets in breeks-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is breeks.cpp.
...
Changes to breeks.cpp
----------------------
breeks.cpp is the entry point into breeks-qt, and as such, will require some minor modifications to provide hooks for
