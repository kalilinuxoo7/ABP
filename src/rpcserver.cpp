...
#ifdef ENABLE_WALLET
        {"abp", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use abpd, or the -server option to abp-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
