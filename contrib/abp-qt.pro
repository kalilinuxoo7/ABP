...
RESOURCES += src/qt/breeks.qrc src/qt/breeks_locale.qrc

TRANSLATIONS += src/qt/locale/breeks_bg.ts \
                src/qt/locale/breeks_de.ts \
                src/qt/locale/breeks_en.ts \
                src/qt/locale/breeks_es.ts \
                src/qt/locale/breeks_fi.ts \
                src/qt/locale/breeks_fr.ts \
                src/qt/locale/breeks_it.ts \
                src/qt/locale/breeks_ja.ts \
                src/qt/locale/breeks_pl.ts \
                src/qt/locale/breeks_pt.ts \
                src/qt/locale/breeks_ru.ts \
                src/qt/locale/breeks_sk.ts \
                src/qt/locale/breeks_sv.ts \
                src/qt/locale/breeks_vi.ts \
                src/qt/locale/breeks_zh_CN.ts \
                src/qt/locale/breeks_zh_TW.ts
